...
import setDefaultOwnerStyle from './setDefaultOwner.css';

class SetDefaultOwnerWindow extends React.Component {
	...
	update(id, avatar, name) {
		const _this = this;
		const result = fetch(`${domainPath}/v2/post/api/system/0/owner`, {
			method: 'post',
			credentials: 'include',
			headers: {
...
export default connect()(SetDefaultOwnerWindow);