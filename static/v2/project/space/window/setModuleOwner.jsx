...
import setModuleOwnerStyle from './setModuleOwner.css';

class SetModuleOwnerWindow extends React.Component {
	...
	update(id, avatar, name) {
		const _this = this;
		const result = fetch(`${domainPath}/v2/post/api/module/${this.props.id}/owner`, {
			method: 'post',
			credentials: 'include',
			headers: {
...
export default connect()(SetModuleOwnerWindow);